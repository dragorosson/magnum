...
if [ "$coe" = "mesos" ]; then
    ...
    export DEVSTACK_LOCAL_CONFIG+=$'\n'"MAGNUM_GUEST_IMAGE_URL='https://test-fedora-23-ironic-image.web.cern.ch/test-fedora-23-ironic-image/fedora-atomic-23-drago.qcow2'"
    export DEVSTACK_LOCAL_CONFIG+=$'\n'"MAGNUM_IMAGE_NAME='fedora-atomic-23-drago'"
fi
